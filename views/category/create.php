...
<div class="forum-box center">
    <form method="post">
            ...
            <select class="form-control" name="parent_id" id="selectCategory" required>
                ...
                <?php foreach ($list as $key => $value): ?>
                    <?php foreach ($value as $inner_key => $inner_value): ?>
                        <?php if ($inner_value['type_id'] != 3 && !Forum::sectionIsTopics($inner_value['id'])): ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="title_name" class="form-control" id="category" placeholder="Введите название"
                   required>
        </div>
        <div class="form-group">
